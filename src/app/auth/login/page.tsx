    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="rounded border-gray-300 text-eu-blue focus:ring-eu-blue" />
                <span className="ml-2 text-sm text-gray-600">Remember me</span>
              </label>
              <Link href="/auth/forgot-password" className="text-sm text-eu-blue hover:underline">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-gray-600 mt-6">
          ...
          <Link href="/auth/register" className="text-eu-blue font-medium hover:underline">
            Sign up
          </Link>
        </p>
      </div>
