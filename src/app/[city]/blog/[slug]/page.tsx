...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: post.title,
      description,
      url: `https://eujobs.co/${city}/blog/${slug}`,
      siteName: 'EU Jobs',
      type: 'article',
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `https://eujobs.co/${city}/blog/${slug}`,
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Blog', item: `https://eujobs.co/${city}/blog` },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link href={`/${city}/blog`} className="hover:text-eu-blue dark:hover:text-blue-400">Blog</Link>
            <span className="mx-2">/</span>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 text-center">
          <Link href={`/${city}/blog`} className="text-eu-blue dark:text-blue-400 font-medium hover:underline">
