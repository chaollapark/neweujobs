    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="bg-gradient-to-br from-eu-blue to-eu-dark text-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href={`/${city}/best-in-brussels/articles`} className="inline-flex items-center text-gray-300 hover:text-white mb-6 transition-colors">&larr; Back to articles</Link>
